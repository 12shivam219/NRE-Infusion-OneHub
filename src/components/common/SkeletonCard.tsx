...
export const SkeletonCard: React.FC = () => {
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 animate-pulse">
      {/* Title skeleton */}
      <div className="h-6 bg-blue-100 rounded mb-4 w-3/4" />
      ...
      <div className="grid grid-cols-2 gap-3 py-4 border-y border-gray-200">
        <div>
          <div className="h-3 bg-blue-100 rounded mb-2 w-20" />
      ...
      <div className="flex gap-2 mt-4">
        <div className="h-10 bg-blue-100 rounded flex-1" />
        <div className="h-10 bg-blue-100 rounded w-10" />
      </div>
    </div>
  );
};
        ...
        <div key={i} className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 animate-pulse">
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1">
              <div className="h-5 bg-blue-100 rounded mb-2 w-1/2" />
              <div className="h-4 bg-blue-100 rounded w-1/3" />
            </div>
            <div className="h-6 bg-blue-100 rounded-full w-20 ml-4 flex-shrink-0" />
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div>
              <div className="h-3 bg-blue-100 rounded mb-2 w-16" />
